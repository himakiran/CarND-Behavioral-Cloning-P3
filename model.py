...
train_lines_balanced = balance_data(np.array(train_lines),60,100)
validation_lines_balanced = balance_data(np.array(validation_lines),60,100)
# Checking 
...
validation_generator = generator(validation_lines_balanced, batch_size=40)
...
model.fit_generator(train_generator, steps_per_epoch=len(train_lines)*1,\
