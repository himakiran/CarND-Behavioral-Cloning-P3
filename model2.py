...
#PTH_CSV = "../../../opt/carnd_p3/driving_log.csv"
#PTH_IMG = "../../../opt/carnd_p3/IMG/"
...
model.fit(X_train, y_train, validation_data=(X_valid,y_valid), epochs=1, batch_size=40,callbacks=[checkpoint])
